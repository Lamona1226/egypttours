...
export const metadata: Metadata = {
  title: 'About Us | Egypt Tours',
  description: 'Learn about Egypt Tours — a Cairo-based family-run tour company established in 2005.',
};
    ...
    <div>
      ...
      <section className="bg-slate-800 py-20 text-center text-white">
        <div className="mx-auto max-w-6xl px-4">
          <h1 className="text-4xl font-bold sm:text-5xl">About Egypt Tours</h1>
      ...
      <section className="mx-auto max-w-4xl px-4 py-16">
        <h2 className="text-center text-3xl font-bold text-gray-900">Our Story</h2>
        <div className="mt-8 space-y-5 leading-relaxed text-gray-600">
          <p>
            Egypt Tours was founded in 2005 by a Cairo-based family with a deep passion for
      ...
      <section className="bg-gray-50 py-12">
        <div className="mx-auto grid max-w-6xl gap-6 px-4 sm:grid-cols-2 lg:grid-cols-4">
          {stats.map((stat) => (
            <div
              key={stat.label}
              className="rounded-xl border-2 border-[#C9A84C] bg-white p-6 text-center"
            >
